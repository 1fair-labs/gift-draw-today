...
export default function AboutScreen() {
  ...
  const content = [
    ...
    { text: "All draws are executed on Solana: 100% on-chain, immutable, and publicly verifiable. Real-time data includes: participant count, prize pool amount, winner count, and a unique draw hash. Nothing is hidden. Nothing is editable. What's on-chain is final." },
    { text: "" },
