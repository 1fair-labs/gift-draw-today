...
export default function AboutScreen() {
  ...
  const content = [
    ...
    { text: "Welcome", isHeading: true, isSmallText: true },
    { text: "Free for users invited by friends. Weight: 0.5", isSmallText: true },
    { text: "" },
    { text: "Referral", isHeading: true, isSmallText: true },
