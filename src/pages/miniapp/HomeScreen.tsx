        ...
        <Card className="glass-card overflow-hidden relative">
          <div className="p-6">
            ...
            <div className="mb-3">
              ...
              <p className={`text-2xl md:text-3xl font-black text-neon-gold transition-all duration-300 ${animatingValues.jackpot ? 'value-updated' : ''}`} style={{ textDecoration: 'none' }}>
            ...
            <div className="grid grid-cols-1 gap-4 text-sm mb-3">
              <div>
                ...
                <p className={`text-lg font-bold text-neon-gold leading-tight transition-all duration-300 ${animatingValues.prizePool ? 'value-updated' : ''}`} style={{ textDecoration: 'none' }}>{prizePool.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 }).replace(/,/g, ' ')} GIFT</p>
                <p className="text-xs text-muted-foreground mt-1" style={{ textDecoration: 'none' }}>
                  ≈ ${prizePoolUsd} USDT
                </p>
              </div>
            ...
            <div className="grid grid-cols-2 gap-4 text-sm mb-3">
              <div>
                ...
                <p className={`text-lg font-bold text-neon-gold leading-tight transition-all duration-300 ${animatingValues.participants ? 'value-updated' : ''}`}>
                  {totalEntries}
                </p>
              ...
              <div>
                ...
                <p className={`text-lg font-bold text-neon-gold leading-tight transition-all duration-300 ${animatingValues.winners ? 'value-updated' : ''}`}>
                  {totalWinners}
                </p>
                <p className="text-sm text-muted-foreground mt-0.5">
