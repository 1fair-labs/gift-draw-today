...
// Telegram icon component (airplane)
const TelegramIcon = ({ className }: { className?: string }) => (
  ...
  >
    <path
      d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm5.562 8.193l-1.87 8.81c-.14.625-.52.78-1.05.485l-2.9-2.14-1.4 1.345c-.13.13-.24.24-.49.24l.21-2.98 5.36-4.84c.23-.21-.05-.33-.36-.12l-6.62 4.17-2.85-.89c-.62-.19-.64-.62.13-.95l11.26-4.34c.52-.19.98.12.81.67z"
      fill="currentColor"
    />
  </svg>
);
